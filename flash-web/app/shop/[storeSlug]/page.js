...
import { ShoppingBag, Phone, Loader2, Check, Zap, AlertCircle, Shield, ChevronDown, Package, ArrowRight, Clock, Wifi, Moon, Sun, GraduationCap } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="flex-1 text-center sm:text-left">
              ...
              {store?.description && (
                <p className="text-white/80 text-sm sm:text-base mb-4">{store.description}</p>
              )}
