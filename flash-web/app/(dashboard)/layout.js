    ...
    <div className="flex h-screen bg-background">
      ...
      {supportWhatsapp ? (
        <a
          ...
          className={`fixed z-30 left-4 flex items-center gap-2 px-4 h-12 bg-[#25D366] hover:bg-[#1ebe57] rounded-full shadow-lg shadow-[#25D366]/30 transition-all hover:scale-105 ${isMobile ? 'bottom-20' : 'bottom-6'}`}
        ...
        >
          ...
          <span className="text-white text-xs font-bold hidden sm:inline">Support</span>
        </a>
      ) : (
        <a
