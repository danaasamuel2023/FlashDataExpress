  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* Floating WhatsApp support button.
          Signed-out visitors only see the WhatsApp channel link (no admin contact). */}
      <a
        href={user && supportWhatsapp
        ...
        title={user ? 'WhatsApp Support' : 'Join our WhatsApp channel'}
      >
        ...
        <span className="text-white text-xs font-bold">{user ? 'Support' : 'Join Channel'}</span>
      </a>
