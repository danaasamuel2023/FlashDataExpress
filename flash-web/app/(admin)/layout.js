...
import {
  ...
  Menu, X, ChevronRight, LogOut, Zap, Gift, DollarSign, ExternalLink, Store, Undo2, ShoppingBag, UserPlus, Megaphone, KeyRound, Clock3
} from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/pending-orders', label: 'Pending Orders', icon: Clock3 },
